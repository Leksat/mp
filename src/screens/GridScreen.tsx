...
import { factProgressShare, factState, learnedPercent, type Progress } from '../domain/progress'
...
export const GridScreen = ({ progress, onForget }: GridScreenProps) => {
  ...
  return (
    <div className="grid-screen">
      ...
      <div className="table" style={{ '--columns': FACTORS.length + 1 }}>
          ...
          ...FACTORS.map((column) => {
            ...
            return (
              <button
                ...
                style={{ '--streak-progress': factProgressShare(progress, fact) }}
